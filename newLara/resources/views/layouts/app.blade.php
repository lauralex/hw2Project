        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('css/favicon_red.png')}}" width="32" height="32" class="d-inline-block mr-1" alt="MyBells">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item @yield('create_post')">
                            <a class="nav-link" href="{{route('create_post')}}">Create Post</a>
                        </li>
                        <li class="nav-item @yield('search_users')">
                            <a class="nav-link" href="{{route('search_people_index')}}">Search Users</a>
                        </li>
